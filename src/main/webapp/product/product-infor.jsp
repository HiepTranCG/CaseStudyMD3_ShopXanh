                    ...
                    <div class="pb-3" data-aos="fade-in">
                        ...
                        <c:if test="${roleId==2}">
                            <form method="get" action="">
                                ...
                                <button class="btn btn-dark w-100 mt-4 mb-0 hover-lift-sm hover-boxshadow">Edit</button>
                            </form>
                            <form method="get" action="">
                                <input type="hidden" name="action" value="delete">
                                <input type="hidden" name="id" value="${product.id}">
                                <button class="btn btn-dark w-100 mt-4 mb-0 hover-lift-sm hover-boxshadow">Delete</button>
                            </form>
                        </c:if>
                        <!-- Product Highlights-->
                        <div class="my-5">
            ...
            <div class="col-12" data-aos="fade-up">
                ...
                <div class="swiper-container" data-swiper data-options='{
                    ...
                    <div class="swiper-wrapper">
                        <%--                          <c:forEach var="selectproduct" items="${productList}">--%>
                        ...
                        <%--                                              <img class="w-100 img-fluid position-relative z-index-10" title="" src="${selectproduct.image}" alt="">--%>
                        <%--                                          </picture>--%>
                        ...
                        <%--                                          <a class="text-decoration-none link-cover" href="/products?id=${selectproduct.img}">${selectproduct.name}</a>--%>
                        <%--                                          <small class="text-muted d-block">${selectproduct.description}</small>--%>
                        <%--                                          <p class="mt-2 mb-0 small"><s class="text-muted">$329.99</s> <span class="text-danger">$${selectproduct.price}</span></p>--%>
                        <%--                                      </div>--%>
                        <%--                                  </div>--%>
                        <%--                                  <!--/ Card Product-->--%>
                        <%--                              </div>--%>

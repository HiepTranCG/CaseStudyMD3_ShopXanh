    ...
    <div class="container-fluid" data-aos="fade-in">
        ...
        <div style="margin-bottom: 20px">
            <button type="button" data-toggle="modal" data-target="#staticBackdrop" style="width: 30%;">
                <a href="/product-managements?action=create">Add Product</a>
            </button>
        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                        <div class="card-img position-relative">
                            ...
                            <span class="position-aabsolute top-0 end-0 p-2 z-index-20 text-muted"><i class="ri-heart-line"></i></span>

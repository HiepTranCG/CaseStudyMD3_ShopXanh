        ...
        <div class="container">
            <div class="row g-0 vh-lg-100">
                <div class="col-lg-7 pt-5 pt-lg-10">
                    <div class="pe-lg-5">
                        <!-- Logo-->
                        <a class="navbar-brand fw-bold fs-3 flex-shrink-0 mx-0 px-0" href="../index.jsp">
                        ...
                        <nav class="d-none d-md-block">
                            <ul class="list-unstyled d-flex justify-content-start mt-4 align-items-center fw-bolder small">
                                <li class="me-4"><a class="nav-link-checkout "
                                        href="cart.jsp">Your Cart</a></li>
                                <li class="me-4"><a class="nav-link-checkout "
                                        href="checkout.jsp">Information</a></li>
                                ...
                                <li><a class="nav-link-checkout nav-link-last "
                                        href="checkout-payment.jsp">Payment</a></li>
                            </ul>
                        </nav>                        <div class="mt-5">
                            ...
                            <ul class="list-group mb-5 d-none d-lg-block rounded-0">
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="checkout.jsp" class="text-muted small" role="button">Change</a>
                                </li>
                            ...
                            <div class="pt-5 mt-5 pb-5 border-top d-flex flex-column flex-md-row justify-content-between align-items-center">
                              <a href="checkout.jsp" class="btn ps-md-0 btn-link fw-bolder w-100 w-md-auto mb-2 mb-md-0" role="button">Back to information</a>
                              <a href="checkout-payment.jsp" class="btn btn-dark w-100 w-md-auto" role="button">Proceed to payment</a>
                            </div>
                        </div>
                    </div>
                </div>
